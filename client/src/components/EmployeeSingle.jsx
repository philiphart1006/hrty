...
import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Card, SimpleGrid } from "@chakra-ui/react"

// * Default function
export default function EmployeeSingle(){

  const employee = useLoaderData()
  const { username, first_name, last_name, team, manager, status, join_date, softwares, reviews_received } = employee
